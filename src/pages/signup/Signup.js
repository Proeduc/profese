...
export default function Signup() {
  ...
  const validate = () => { 
    ...
    if(password.length < 8 || !regexp.test(String(email).toLowerCase())) return false
    else return true
  }
  const register = (e) => {
    e.preventDefault(); 
      ...
      <div className="signup container">
       <div className="row">
           <div className="signup_text col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                ...
                <h4>
                Join profese to get 1-on-1 online help for courses and assignments.
                </h4>
                <h4>
           ...
           <div className="signup_input col-lg-6 col-md-6 col-sm-6 col-xs-12">
               <form onSubmit={register}>
                <div className="manual_signup container-fluid">
                    <div className="signup_profile_choice">
                        ...
                        <div className="choices"> 
                          <input 
                            ...
                            required
                          />
                          <label htmlFor="student" style={{color:"black"}}> &nbsp; Student &nbsp;</label>
                          <input 
                            type="radio"
                            name="profile"
                            id="tutor" 
                            ...
                            onChange={(e) => setProfile(e.target.value)}
                          />
                          <label htmlFor="tutor" style={{color:"black"}}> &nbsp;Tutor</label>
                        </div>
                    </div>
                    ...
                    required
                    /> 
                    <button onClick="register" className="signup_btn btn btn-block btn-primary">Sign Up</button>
